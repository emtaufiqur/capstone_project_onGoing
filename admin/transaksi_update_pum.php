...
if($filename == ""){
	mysqli_query($koneksi, "update transaksi_pjum set transaksi_id='$id', transaksi_tanggal='$tanggal', transaksi_kategori='$kategori', transaksi_nominal='$nominal', transaksi_keterangan='$keterangan', transaksi_tanggal_kebutuhan='$tanggal_kebutuhan' where transaksi_id='$id'") or die(mysqli_error($koneksi));
	...
	if(!in_array($ext,$allowed) ) {
		...
		mysqli_query($koneksi, "update transaksi_pjum set transaksi_id='$id', transaksi_tanggal='$tanggal', transaksi_kategori='$kategori', transaksi_nominal='$nominal', transaksi_keterangan='$keterangan', transaksi_tanggal_kebutuhan='$tanggal_kebutuhan', transaksi_foto='$xgambar' where transaksi_id='$id'");
